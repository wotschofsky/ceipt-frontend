...
function Row({ idx }: { idx: number }) {
    ...
    const ding = `M8 ${rowHeight * idx + 14} C21.1667 ${rowHeight * idx + 14} 151 ${rowHeight * idx + 14} 151 ${rowHeight * idx + 14}`

    return <>
        <rect y={rowHeight * idx} width="158" height="15" fill="white" />
        <path d={ding} stroke="#808080" stroke-width="0.5" stroke-dasharray="2 2" />
        <text fill="#222222" style={{ whiteSpace: "pre" }} font-family="Inter" font-size="5" letter-spacing="0em"><tspan x="8" y={rowHeight * idx + 8.8182}>QTY</tspan></text>
        <text fill="#222222" style={{ whiteSpace: "pre" }} font-family="Inter" font-size="5" letter-spacing="0em"><tspan x="41" y={rowHeight * idx + 8.8182}>DESCRIPTION</tspan></text>
        <text fill="#222222" style={{ whiteSpace: "pre" }} font-family="Inter" font-size="5" letter-spacing="0em"><tspan x="97" y={rowHeight * idx + 8.8182}>STATUS</tspan></text>
        <text fill="#222222" style={{ whiteSpace: "pre" }} font-family="Inter" font-size="5" letter-spacing="0em"><tspan x="133" y={rowHeight * idx + 8.8182}>KG CO&#x2082;</tspan></text>
    </>
}
...
function Footer({ idx }: any) {
    ...
    return <>
        <rect y={rowHeight * idx} width="158" height="15" fill="white" />
        <text fill="#222222" style={{ whiteSpace: "pre" }} font-family="Inter" font-size="7" font-weight="bold" letter-spacing="0em"><tspan x="104" y={rowHeight * idx + 10.5455}>VEGETARIAN</tspan></text>
        <text fill="#222222" style={{ whiteSpace: "pre" }} font-family="Inter" font-size="7" font-weight="bold" letter-spacing="0em"><tspan x="23" y={rowHeight * idx + 10.5455}>TOTAL:</tspan></text>
        <text fill="#222222" style={{ whiteSpace: "pre" }} font-family="Inter" font-size="7" font-weight="bold" letter-spacing="0em"><tspan x="66" y={rowHeight * idx + 10.5455}>24.4</tspan></text>
...
export default function ReceiptSvg({ receipt }: any) {
    ...
    return <svg width="158" height={numRows * rowHeight} viewBox={viewBox} fill="none" xmlns="http://www.w3.org/2000/svg">
        <Start idx={0} />
        <Header idx={1} />

        {items.map((i, idx) => <Row idx={idx + 2} />)}
...
const getHeader = (idx: number) => {
    ...
    return `<rect y="${rowHeight * idx}" width="158" height="15" fill="white"></rect>`
}
const getFooter = (idx: number) => {

    return `
        <rect y="${rowHeight * idx}" width="158" height="15" fill="white"></rect>
        <text fill="#222222" style="white-space: pre" font-family="Inter" font-size="7" font-weight="bold" letter-spacing="0em"><tspan x="104" y="${rowHeight * idx + 10.5455}">VEGETARIAN</tspan></text>
        <text fill="#222222" style="white-space: pre" font-family="Inter" font-size="7" font-weight="bold" letter-spacing="0em"><tspan x="23" y="${rowHeight * idx + 10.5455}">TOTAL:</tspan></text>
        <text fill="#222222" style="white-space: pre" font-family="Inter" font-size="7" font-weight="bold" letter-spacing="0em"><tspan x="66" y="${rowHeight * idx + 10.5455}">24.4</tspan></text>
    `
}
